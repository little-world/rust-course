...
[**12. Atomic Operations & Lock-Free**](12-atomic-lock-free.md)
...
[**A. Quick Reference**](appendix-a-quick-reference.md)
- Type conversion cheatsheet
- Common trait implementations
- Iterator combinators reference
- Cargo commands

[**B. Design Pattern Catalog**](appendix-b-design-pattern-catalog.md)
- Creational patterns
- Structural patterns
- Behavioral patterns
- Concurrency patterns

[**C. Anti-Patterns**](appendix-c-anti-patterns.md)
- Common pitfalls
